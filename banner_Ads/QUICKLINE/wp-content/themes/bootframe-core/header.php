...
<!-- Navigation -->
<nav
    class="<?php echo apply_filters('smartlib_main_navigation_class', 'navbar navbar-inverse  navbar-default  smartlib-navbar smartlib-default-top-navbar panel-row-style') ?>"
    role="navigation">
